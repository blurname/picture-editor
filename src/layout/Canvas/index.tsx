...
export function Canvas() {
  const { globalCanvas, cmpCount} = useContext(globalContext)
	const tCmp:Cmp ={id:0,width:200,height:200,posX:100,posY:100,value:'../../../../public/test.jpg',image:undefined} 
  ...
  return (
    <div className="Canvas">
		<div>
		<img src={tCmp.image.src} width={tCmp.image.width} height={tCmp.image.height} alt=""/>
		</div>
      <div>Canvas</div>
			<ImageCanvas/>
			<TCanvas/>
